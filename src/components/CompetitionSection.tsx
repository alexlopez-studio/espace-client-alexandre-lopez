...
export default function CompetitionSection({
  ...
  return (
    <div className="w-full flex flex-col gap-6 lg:p-4" id="competition-section-container">
      ...
      {/* Sub-tabs / Menubar */}
      <div className="w-full border border-slate-200/80 bg-white p-1.5 shadow-xs rounded-2xl gap-1.5 overflow-x-auto flex items-center scrollbar-none" id="competition-sub-menubar">
        {subTabs.map((tab) => {
          const Icon = tab.icon;
